const districtData = {
    "Kolar": { "predicted_cases": 7, "risk_score": 80.2, "threshold": 0.0, "status": "Critical", "top_driver": "Rising Case Trend" },
    "Mysuru": { "predicted_cases": 11, "risk_score": 72.6, "threshold": 7.0, "status": "High", "top_driver": "High Humidity Levels" },
    "Chitradurga": { "predicted_cases": 11, "risk_score": 69.5, "threshold": 8.0, "status": "High", "top_driver": "High Average Temperature" },
    "Chamarajanagara": { "predicted_cases": 7, "risk_score": 67.9, "threshold": 4.0, "status": "High", "top_driver": "Rising Case Trend" },
    "Kodagu": { "predicted_cases": 3, "risk_score": 67.5, "threshold": 1.0, "status": "High", "top_driver": "Heavy Rainfall" },
    "Belagavi": { "predicted_cases": 10, "risk_score": 66.6, "threshold": 2.0, "status": "High", "top_driver": "Rising Case Trend" },
    "Bengaluru Rural": { "predicted_cases": 5, "risk_score": 65.5, "threshold": 0.0, "status": "Medium", "top_driver": "High Population Density" },
    "Shivamogga": { "predicted_cases": 11, "risk_score": 64.7, "threshold": 12.0, "status": "Medium", "top_driver": "Rising Case Trend" },
    "Mandya": { "predicted_cases": 9, "risk_score": 61.2, "threshold": 3.0, "status": "Medium", "top_driver": "High Humidity Levels" },
    "Tumakuru": { "predicted_cases": 4, "risk_score": 61.1, "threshold": 3.25, "status": "Medium", "top_driver": "Rising Case Trend" },
